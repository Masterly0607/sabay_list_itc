...
import 'package:sabay_list_itc/services/task_service.dart' as task_service;
...
class _HomeScreenContentState extends State<HomeScreenContent> {
  late task_service.TaskService _taskService;
  int selectedDateIndex = 0;
  bool isTaskDropdownExpanded = false;
  bool isCompletionDropdownExpanded = false;

  @override
  void initState() {
    super.initState();
    _taskService = task_service.TaskService();
    _taskService.addListener(_onTasksChanged);
    final taskDates = _taskService.taskDates;
    final today = DateTime.now();
    final todayIndex = taskDates.indexWhere(
      (date) =>
  ...
  void _navigateToTaskDetail(task_service.Task task) async {
      ...
      MaterialPageRoute(
        builder: (context) => TaskDetailScreen(
          ...
          onTaskUpdated: (updatedTask) {
            _taskService.updateTask(updatedTask as task_service.Task);
          },
  ...
  void _navigateToTodoTask() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TodoTaskPage()),
    );
  }
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(8),
                            border: Border.all(
                              color: task.borderColor.withOpacity(0.3),
                            ),
                          ),
                          child: ListTile(
                            dense: true,
